...
import LanguageContext from "./_LanguageContext";
import { useRouter } from "next/router";
          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            <nav aria-label="Global" className="hidden md:block">
              ...
              <li>
                ...
                <li className="relative">
                  <button
                    className={activeLink === '/categories' ? 'text-primary transition hover:text-secondary font-bold' : 'text-gray-500 transition hover:text-gray-500/75 font-medium'}
                    onClick={toggleDropdown}
                  >
                    {translate('categories', language)}
                  </button>
